/*
* 	The environment variables assumed to be set are -
*	- process.env.hostname - String with the Gitlab hostname with port
*	- process.env.username - Username of Gitlab Administrator
*	- process.env.password - Password for the account of Gitlab Administrator
*/
